...
const Nav = () => {
  ...
  //  Using context
  let {input,setInput,setCategory,toggle,setToggle,cartItems} = useContext(dataContext);
// search box
  useEffect(() =>{
  ...
  return (
    <div className="w-full h-20 px-6 bg-gray-100 flex items-center justify-between shadow-md">
      ...
      {/* Cart */}
      <div className="w-16 h-16  bg-white flex justify-center items-center text-4xl  rounded-xl shadow relative cursor-pointer "
